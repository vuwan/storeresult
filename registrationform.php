...
";
			...
			$sql = "INSERT INTO `registrationtable` (`FName`, `LName`, `FaName`, `DOB`, `Addrs`, `Gender`, `PhNo`, `Eid`, `Pass`,`Course`,`marks`) VALUES ('$fname','$lname','$faname','$dob','$addrs','$gender','$phno','$email','$pass','$course','$marks')";
...
Female</label>
					...
					<div class="controls">
							<label>Total Marks <span style="color: #ff0000;">*</span></label>
							<input type="text" class="form-control" name="marks" id="marks" maxlength="30">
							<p class="help-block"></p>
						</div>
					</div>
